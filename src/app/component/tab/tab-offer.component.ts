        ...
        <ui-tabs-menu *ngIf="mode == 0">
            <ui-tab [title]="'ГЛАВНАЯ'">
                <ng-container *ngIf="!editEnabled">
                    ...
                    <div class="show_block">
                        <span>Сделка</span>
                        <span class="view-value">{{ offClass.offerTypeCodeOptions[offer.offerTypeCode]?.label}}</span>
                    </div>
                    <div class="show_block">
                    ...
                    <ng-container *ngIf="block.getAsArray(offer.contractBlock)?.length > 0">
                        ...
                        <div class="show_block" *ngIf="offer?.contractBlock?.begin || offer.contractBlock?.end">
                            ...
                            <span class="view-value">{{ offer.contractBlock?.begin}}-{{offer.contractBlock?.end}}</span>
                        </div>
            ...
            <ui-tab [title]="'ОБЪЕКТ'">
                <ng-container *ngIf="!editEnabled">
                    ...
                    <div class="show_block">
                        ...
                        <span class="view-value">{{ offClass.buildingTypeOptions[offer?.buildingType]?.label}}</span>
                    </div>
                    <div class="show_block" *ngIf="offer.categoryCode != 'land'">
                        <span>{{offer.categoryCode == 'rezidential' ? "Тип недвижимости" : "Класс здания"}}</span>
                        <span class="view-value">{{ offClass.buildingClassOptions[offer?.buildingClass]?.label}}</span>
                    </div>
                    <div class="show_block">
                    ...
                    <ng-container *ngIf="offer.typeCode == 'apartment' || offer.typeCode == 'room' || offer.typeCode == 'share'">
                        <div class="show_block">
                        ...
                        <div class="show_block" *ngIf="offer.roomsCount != 1 && offer.typeCode != 'room'">
                            ...
                            <span class="view-value">{{ offClass.roomSchemeOptions[offer?.roomScheme]?.label}}</span>
                        </div>
                    ...
                    <ng-container *ngIf="offer.typeCode == 'house' || offer.typeCode == 'cottage' || offer.typeCode == 'dacha' || offer.typeCode == 'townhouse' || offer.typeCode == 'duplex'">
                        <div class="show_block" *ngIf="offer?.floor">
                            <span>Этаж</span>
                            <span class="view-value">{{ offer.floor }}</span>
                        </div>
                ...
                <ng-container *ngIf="editEnabled">
                    ...
                    ></sliding-menu>
                    <sliding-menu [name] = "offer?.categoryCode != 'land' ? (offer.categoryCode == 'rezidential' ? 'Тип дома' : 'Тип недвижимости') : 'Назначение земель'"
                    ...
                    <input-line *ngIf="offer.categoryCode != 'land'"
                                [name]="offer?.newBuilding ? 'Дата сдачи объекта' : 'Год постройки'" [value]="offer?.buildYear"
                                (newValue)="offer.buildYear = $event"
                    ></input-line>
                    <ng-container *ngIf="offer.offerTypeCode != 'rent'">
                        <div class="show_block">
                            <span>Обременение</span>
                            <switch-button [value]="offer?.encumbrance" (newValue)="offer.encumbrance = $event"></switch-button>
                        </div>
                        <div class="show_block">
                            <span>Подходит под ипотеку</span>
                            <switch-button [value]="offer?.mortgages" (newValue)="offer.mortgages = $event"></switch-button>
                        </div>
                    </ng-container>
                    <ng-container *ngIf="offer.typeCode == 'apartment' || offer.typeCode == 'room' || offer.typeCode == 'share'">
                        <sliding-menu *ngIf="offer.newBuilding"
                        ...
                        ></sliding-menu>
                        <input-line [name]="'Количество комнат'" [value]="offer?.roomsCount" (newValue)="offer.roomsCount = $event"></input-line>
                        ...
                        ></sliding-menu>
                        <input-line [name]="'Этаж'" [value]="offer?.floor" (newValue)="offer.floor = $event"></input-line>
                        <input-line [name]="'Этажность'" [value]="offer?.floorsCount" (newValue)="offer.floorsCount = $event"></input-line>
                        <input-line [name]="'Уровней'" [value]="offer?.levelsCount" (newValue)="offer.levelsCount = $event"></input-line>
                        <input-line [name]="'Общая площадь'" [value]="offer?.squareTotal" (newValue)="offer.squareTotal = $event"></input-line>
                        <input-line [name]="'Жилая площадь'" [value]="offer?.squareLiving" (newValue)="offer.squareLiving = $event"></input-line>
                        <input-line [name]="'Площадь кухни'" [value]="offer?.squareKitchen" (newValue)="offer.squareKitchen = $event"></input-line>
                        <ng-container *ngIf="offer.buildingType == 'lowrise_house'">
                            <input-line [name]="'Площадь участка'" [value]="offer?.squareLand" (newValue)="offer.squareLand = $event"></input-line>
                        ...
                        <div class="show_block">
                            <span>Лоджия</span>
                            <switch-button [value]="offer?.loggia" (newValue)="offer.loggia = $event"></switch-button>
                        </div>
                        <div class="show_block">
                            <span>Балкон</span>
                            <switch-button [value]="offer?.balcony" (newValue)="offer.balcony = $event"></switch-button>
                        </div>
                    ...
                    <ng-container *ngIf="offer.typeCode == 'house' || offer.typeCode == 'cottage' || offer.typeCode == 'dacha' || offer.typeCode == 'townhouse' || offer.typeCode == 'duplex'">
                        ...
                        <div class="show_block">
                            <span>Водоснабжение</span>
                            <switch-button [value]="offer?.waterSupply" (newValue)="offer.waterSupply = $event"></switch-button>
                        </div>
                        <div class="show_block">
                            <span>Газификация</span>
                            <switch-button [value]="offer?.gasification" (newValue)="offer.gasification = $event"></switch-button>
                        </div>
                        <div class="show_block">
                            <span>Электроснабжение</span>
                            <switch-button [value]="offer?.electrification" (newValue)="offer.electrification = $event"></switch-button>
                        </div>
                        <div class="show_block">
                            <span>Канализация</span>
                            <switch-button [value]="offer?.sewerage" (newValue)="offer.sewerage = $event"></switch-button>
                        </div>
                        <div class="show_block">
                            <span>Отопление</span>
                            <switch-button [value]="offer?.centralHeating" (newValue)="offer.centralHeating = $event"></switch-button>
                        </div>
                    </ng-container>
                    <ng-container *ngIf="offer.categoryCode == 'land'">
                        <input-line [name]="'Площадь участка'" [value]="offer?.squareLand" (newValue)="offer.squareLand = $event"></input-line>
                    ...
                    <ng-container *ngIf="offer.categoryCode == 'commersial'">
                        <input-line [name]="'Название'" [value]="offer?.objectName" (newValue)="offer.objectName = $event"></input-line>
                        ...
                        <input-line [name]="'Площадь помещения'" [value]="offer?.squareTotal" (newValue)="offer.squareTotal = $event"></input-line>
                        <input-line [name]="'Высота потолков'" [value]="offer?.ceilingHeight" (newValue)="offer.ceilingHeight = $event"></input-line>
                        <sliding-menu [name] = "'Состояние'" [options]="offClass.conditionOptions"
                                      [value]="offer?.condition"
                                      (result) = "offer.condition = $event"
                        ></sliding-menu>
                        ...
                        <div class="show_block">
                            <span>Парковка</span>
                            <switch-button [value]="offer?.parking" (newValue)="offer.parking = $event"></switch-button>
                        </div>
                    </ng-container>
                </ng-container>
<!--                // TODO: переместить label внутрь компонента-->
            ...
            <ui-tab [title]="'УСЛОВИЯ'" *ngIf="offer.offerTypeCode == 'rent'" (tabSelect)="update = {}">
                ...
                <ng-container *ngIf="editEnabled">
                    ...
                    <input-line [name]="'Дата заезда'" [value]="offer?.arrivalDate" (newValue)="offer.arrivalDate = $event"></input-line>
                    <input-line [name]="'Период проживания'" [value]="offer?.period" (newValue)="offer.period = $event"></input-line>
                </ng-container>
                <input-area [name]="'Дополнительно'" [value]="offer?.conditionInfo" (newValue)="offer.conditionInfo = $event" [disabled]="!editEnabled" [update]="update"></input-area>
            </ui-tab>
            <ui-tab [title]="'ЦЕНА'" (tabSelect)="update = {}">
                <ng-container *ngIf="!editEnabled">
                    ...
                    <div class="show_block">
                        <span>Комиссия</span>
                        <span class="view-value">{{ offer?.comission }} {{offClass.commisionTypeOption[offer.commisionType]}}</span>
                    </div>
                    <div class="show_block">
                        <span>MLS</span>
                ...
                <ng-container *ngIf="offer.offerTypeCode == 'rent'">
                    <div class="show_block" >
                        <span>Депозит</span>
                        <switch-button [value]="offer?.prepayment" (newValue)="offer.prepayment = $event" [disabled]="!editEnabled"></switch-button>
                    </div>
                    <div class="show_block" >
                        <span>Счетчик на электроэнергию</span>
                        <switch-button [value]="offer?.electrificPay" (newValue)="offer.electrificPay = $event" [disabled]="!editEnabled"></switch-button>
                    </div>
                    <div class="show_block" >
                        <span>Счетчик на воду</span>
                        <switch-button [value]="offer?.waterPay" (newValue)="offer.waterPay = $event" [disabled]="!editEnabled"></switch-button>
                    </div>
                    <div class="show_block" >
                        <span>Счетчик на газ</span>
                        <switch-button [value]="offer?.gasPay" (newValue)="offer.gasPay = $event" [disabled]="!editEnabled"></switch-button>
                    </div>
                    <div class="show_block" >
                        <span>Отопление</span>
                        <switch-button [value]="offer?.heatingPay" (newValue)="offer.heatingPay = $event" [disabled]="!editEnabled"></switch-button>
                    </div>
                    <div class="show_block" >
